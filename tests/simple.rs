...
mod tests {
    ...
    fn simple() {
        ...
        let _agent = env.start_remote_agents(vec![halo_lib::remote_port()], "127.0.0.0/24");
    ...
    fn multi_agent() {
        ...
        let _agents = env.start_remote_agents(vec![8001, 8002], "127.0.0.0/24");
    ...
    fn recover() {
        ...
        // Start an agent
        let _agent = env.start_remote_agents(vec![8003], "127.0.0.0/24");
